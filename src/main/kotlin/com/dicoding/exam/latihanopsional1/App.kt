 ...
 *  Input = sumOfBigThree(100, 1000, 30, 1) -> Output = 1130 | Penj elasan: 1000 + 100 + 30 = 1130
...
fun sumOfBigThree(vararg numbers: Int): Int {
    val tigaAngkaTerakhir = numbers.sortedDescending().take(3)

    return tigaAngkaTerakhir.sum()
}
